...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        pool_stride=2
        #after pooling
        outH=1+(H-pool_height)//pool_stride
        outW=1+(W-pool_width)//pool_stride
...
#         print(pool_out.shape)
        hidden1_out,fc1_cache=affine_relu_forward(pool_out,W2,b2)
#         print(hidden1_out.shape)
        scores,fc2_cache=affine_forward(hidden1_out,W3,b3)

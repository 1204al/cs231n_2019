...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type=="rnn":
            ...
            raise Exception("Wrong cell_type {}.  Should be rnn or lstm".format(self.cell_type))
        ...
        #2
        x,cache_wordembedding=word_embedding_forward(captions_in,W_embed)
        ...
        #4
        scores,cache_temporal_affine_forward=temporal_affine_forward(h,W_vocab,b_vocab)
        ...
        #4
        dh,dW_vocab,db_vocab=temporal_affine_backward(dscores,cache_temporal_affine_forward)
        
        #3
        dx,dh0,dWx,dWh,db=cell_backward(dh,cache_cell)
        
        #2
        dW_embed=word_embedding_backward(dx,cache_wordembedding)
